...
Coordinate conventions: 0-based frame indices internally, 1-based + strand
positions in the output tables (see interface.py).
"""
...
# Sequences to train on, {id: display name}; the adapter fills this from the input FASTA.
NC_TO_NAME = {}
